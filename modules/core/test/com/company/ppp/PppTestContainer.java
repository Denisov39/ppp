...
public class PppTestContainer extends TestContainer {

    public PppTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ppp/app.properties",
    ...
    public static class Common extends PppTestContainer {

        public static final PppTestContainer.Common INSTANCE = new PppTestContainer.Common();
